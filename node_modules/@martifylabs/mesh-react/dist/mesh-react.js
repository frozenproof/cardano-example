import Le, { useRef as yr, useDebugValue as kt, useContext as _e, createElement as wr, createContext as br, useState as de, useCallback as ct, useEffect as Ge } from "react";
import { BrowserWallet as Ut, Transaction as Sr } from "@martifylabs/mesh";
var qe = { exports: {} }, Y = {};
...
(function(e) {
  process.env.NODE_ENV === "production" ? e.exports = Cr() : e.exports = Er();
})(qe);
function _r(e) {
...
var We = typeof process < "u" && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", yt = typeof window < "u" && "HTMLElement" in window, jr = Boolean(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), Wr = process.env.NODE_ENV !== "production" ? { 1: `Cannot create styled-component for component: %s.
...
function Fe(e) {
  for (var n = arguments.length, r = new Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++)
    r[o - 1] = arguments[o];
  throw process.env.NODE_ENV === "production" ? new Error("An error occurred. See https://git.io/JUIaE#" + e + " for more information." + (r.length > 0 ? " Args: " + r.join(", ") : "")) : new Error($r.apply(void 0, [Wr[e]].concat(r)).trim());
}
var Lr = function() {
  function e(r) {
...
`;
  ...
  for (; et.has(Be); )
    Be++;
  var n = Be++;
  return process.env.NODE_ENV !== "production" && ((0 | n) < 0 || n > 1 << 30) && Fe(16, "" + n), Je.set(e, n), et.set(n, e), n;
}, Fr = function(e) {
  return et.get(e);
}, zr = function(e, n) {
...
var Qr = Kt("5.3.6"), en = function() {
  function e(n, r, o) {
    this.rules = n, this.staticRulesId = "", this.isStatic = process.env.NODE_ENV === "production" && (o === void 0 || o.isStatic) && Jr(n), this.componentId = r, this.baseHash = Oe(Qr, r), this.baseStyle = o, Xt.registerId(r);
  }
  return e.prototype.generateAndInjectStyles = function(n, r, o) {
    ...
    if (this.baseStyle && s.push(this.baseStyle.generateAndInjectStyles(n, r, o)), this.isStatic && !o.hash)
      ...
      for (var g = this.rules.length, y = Oe(this.baseHash, o.hash), C = "", L = 0; L < g; L++) {
        var F = this.rules[L];
        if (typeof F == "string")
          C += F, process.env.NODE_ENV !== "production" && (y = Oe(y, F + L));
        else if (F) {
...
var Zt = Le.createContext();
Zt.Consumer;
var Jt = Le.createContext(), on = (Jt.Consumer, new Xt()), ft = nn();
function an() {
  return _e(Zt) || on;
}
function sn() {
...
function $e(e, n, r, o) {
  ...
  if (Ue(e)) {
    if (typeof (g = e) != "function" || g.prototype && g.prototype.isReactComponent || !n)
      return e;
    var h = e(n);
    return process.env.NODE_ENV !== "production" && qe.exports.isElement(h) && console.warn(ut(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), $e(h, n, r, o);
  }
  var g;
...
To resolve this only create new StyledComponents outside of any render method and function component.`, o = console.error;
    try {
      ...
      }, yr(), i && !Ke.has(r) && (console.warn(r), Ke.add(r));
    } catch (s) {
...
function tr(e, n, r) {
  ...
  var x, I = new en(r, C, o ? e.componentStyle : void 0), k = I.isStatic && c.length === 0, N = function(S, T) {
    return function(E, d, oe, he) {
      ...
      process.env.NODE_ENV !== "production" && kt(G);
      ...
      }(mn(d, _e(er), me) || Te, d, se), we = K[0], ce = K[1], ie = function(A, a, D, f) {
        var B = an(), O = sn(), j = a ? A.generateAndInjectStyles(Te, B, O) : A.generateAndInjectStyles(D, B, O);
        return process.env.NODE_ENV !== "production" && kt(j), process.env.NODE_ENV !== "production" && !a && f && f(j), j;
      }(le, he, we, process.env.NODE_ENV !== "production" ? E.warnTooManyClasses : void 0), be = oe, ve = ce.$as || d.$as || ce.as || d.as || ee, Se = Ze(ve), b = ce !== d ? ke({}, d, {}, ce) : d, v = {};
      for (var w in b)
        w[0] !== "$" && w !== "as" && (w === "forwardedAs" ? v.as = b[w] : (ae ? ae(w, Ot, ve) : !Se || Ot(w)) && (v[w] = b[w]));
      return d.style && ce.style !== d.style && (v.style = ke({}, d.style, {}, ce.style)), v.className = Array.prototype.concat(ye, G, ie !== G ? ie : null, d.className, ce.className).filter(Boolean).join(" "), v.ref = be, wr(ve, v);
    }(x, S, T, k);
  };
  return N.displayName = y, (x = Le.forwardRef(N)).attrs = L, x.componentStyle = I, x.displayName = y, x.shouldForwardProp = F, x.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : Qe, x.styledComponentId = C, x.target = o ? e.target : e, x.withComponent = function(S) {
  ...
  } }), process.env.NODE_ENV !== "production" && (hn(y, C), x.warnTooManyClasses = function(S, T) {
    var E = {}, d = !1;
    return function(oe) {
...
function Sn() {
  if (Yt)
    return ze;
  Yt = 1;
  var e = Le, n = Symbol.for("react.element"), r = Symbol.for("react.fragment"), o = Object.prototype.hasOwnProperty, i = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, s = { key: !0, ref: !0, __self: !0, __source: !0 };
  function c(p, h, g) {
...
(function(e) {
  process.env.NODE_ENV === "production" ? e.exports = Sn() : e.exports = Cn();
})(tt);
const Ve = tt.exports.Fragment, H = tt.exports.jsx, He = tt.exports.jsxs, En = fe.svg.withConfig({
  ...
  const [e, n] = de(void 0), [r, o] = de(!1), [i, s] = de(Ie.walletInstance), [c, p] = de(Ie.walletName), h = ct(async (y) => {
    o(!0);
    try {
      const C = await Ut.enable(y);
      s(C), p(y), n(void 0);
    } catch (C) {
      n(C), console.error(C);
    }
